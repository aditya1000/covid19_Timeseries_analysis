...
SIR_model_simulate(args[1],as.numeric(args[2]),as.numeric(args[3]),as.numeric(args[4]),as.numeric(args[5]))
...
#       #print(out)
#       out <- ode(init, Day, sis_model, parameters)
#       #print(out)
#       fit <- out[,3]
...
#                    lower = c(int_beta1,int_gamma1),
#                    upper = c(int_beta2,int_gamma2))
#     }else{
